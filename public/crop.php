...
class CropAvatar
{
    ...
    private function setFile($file)
    {
        ...
        if ($errorCode === UPLOAD_ERR_OK) {
            ...
            if ($type) {
                ...
                $src = getcwd().'/images/' . date('YmdHis') . '.original' . $extension;
    ...
    {
        $this -> dst = getcwd().'/images/' . date('YmdHis') . '.png';
    }
...
$crop = new CropAvatar($_POST['avatar_src'], $_POST['avatar_data'], $_FILES['avatar_file'], $_GET['minCropBoxWidth'], $_GET['minCropBoxHeight']);
