                ...
                success: function (response) {
                    ...
                    if (response.code == 200 && response.data.length > 0) {
                        ...
                        html = response.data.reduce(function (previousValue, currentValue) {
                            var temp = '';
                            var redirect_url = window.location.protocol + "//" + window.location.hostname + "/home/fast-calc/lux/applications/" + application_id + "/rooms/" + room_id + "/products/" + currentValue.product_id + "/articles/" + currentValue.articlecode;
                ...
                success: function (response) {
                    ...
                    if (response.data && response.data.length > 0) {
                        ...
                        $(response.data).each(function (i, v) {
                            console.log(v);
                            var redirect_url = window.location.protocol + "//" + window.location.hostname + "/home/fast-calc/lux/applications/" + application_id + "/rooms/" + room_id + "/products/" + v.product_id;
