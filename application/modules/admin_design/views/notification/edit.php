                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-4">
                        <div class="image-view-wrapper img-view150p img-viewbdr-radius4p">
                            <div class="image-view img-view150" id="profilePic" style="background-image:url('http://localhost/smartguide/AdminPanel//public/uploads/b250449195b136dc63d162c77f6ce542.png');">
                    ...
                    <div class="col-lg-9 col-sm-8">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <input type="button" onclick="return checkNotiValidation()" class="commn-btn" value="Cancel">
                            </div>
