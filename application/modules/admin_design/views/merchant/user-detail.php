...
<div class="inner-right-panel">
    ...
    <div class="breadcrumb-wrap">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Merchant Profile</li>
        </ol>
    </div>
                        ...
                        <div class="user-detail-panel">
                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-holder">
                                        <span class="text-detail">+91 9656568780</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-holder">
                                        <span class="text-detail">Oslo Norway</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="user-detail-panel">
                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-holder">
                                        <span class="text-detail">Johansan & Sons</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6 col-xs-12">
        ...
        <div class="inner-filter-wrap">
            ...
            <div class="fltr-field-wrap">
                ...
                <div class="inputfield-wrap">
                    <input type="text" name="startDate" data-provide="datepicker" value="" class="form-control startDate" id="startDate" placeholder="From">
                </div>
            </div>

            <div class="fltr-field-wrap">
                <div class="inputfield-wrap">
                    <input type="text" name="endDate" data-provide="datepicker" value="" class="form-control endDate" id="endDate" placeholder="To">
                </div>
            </div>
            <div class="fltr-field-wrap">
    ...
    <div class="section">
        <p class="tt-count">Total Projects</p>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-nowrap table-action">
                            <a href="<?php echo base_url()?>admin/merchant/project" class="f-eye"><i class="fa fa-eye" title="View"></i></a>
