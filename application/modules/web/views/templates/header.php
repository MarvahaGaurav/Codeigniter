                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <div class="navbar-topheader-menu clearfix">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>web/index/logout">Logout</a></li>
                                    <?php }else{ ?>
                                    <li>
                                        <a href="javascript:void(0)" class="guest"><cite>Hi!</cite> &nbsp;
                                    ...
                                    <li><a href="<?php echo base_url(); ?>web/index/index">Login</a></li>
                                    <li><a href="<?php echo base_url(); ?>web/index/signup">Signup</a></li>
                                    <?php } ?>
                                </ul>
                            </div>
