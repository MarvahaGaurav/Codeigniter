                ...
                <div id="product-<?php echo $key ?>" class="col-lg-3 col-md-3 col-sm-6 col-xs-12 col-for-thumb" title="<?php echo strip_tags($product['title']) ?>">
                    <div class="thumb-box">
                        <div class="thumb-view-wrapper thumb-view-contain thumb-view-contain-pd thumb-view-fullp img-viewbdr-radius4" data-redirect-to="">
                            ...
                            <span id="delete-thumb" class="selected-accessory-product" title="<?php echo $this->lang->line('remove_product') ?>" data-url="" data-target="#product-<?php echo $key ?>" data-json='<?php echo $product['remove_data'] ?>' data-action="remove-element" data-redirect="<?php echo base_url(uri_string()) ?>" data-title="<?php echo $this->lang->line('remove_product_title') ?>" data-message="<?php echo sprintf($this->lang->line("remove_product_message"), $product['product_name']) ?>"><i class="fa fa-plus" aria-hidden="true"></i></span>
                            <?php } ?>
                        </div>
