<div class="inner-container">
    <div class="container">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo base_url('home/quotes/projects/'.$projectId.'/'.$requestId) ?>">Project Details</a></li>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td  class="text-nowrap action-user">
                            <a href="<?php echo base_url("/home/quotes/projects/".encryptDecrypt($quote['project_id'], 'encrypt').'/'.$requestId."/quotations/levels") ?>" class="project-action" title="View"><i class="fa fa-eye"></i></a>
