<div class="inner-container">
    <div class="container">
        ...
        <div id="awaitingtab" class="multitable active">
            <div class="table-responsive table-wrapper" id="scrollbar-inner">
                <table cellspacing="0" class="table-custom">
                    ...
                    <tbody>
                        <tr>
                            <td class="op-semibold">Adam Smith & Sons</td>
                            <td>Andrew Graham Electricals</td>
                            <td>Oslo, Norway</td>
        ...
        <div id="submittedtab" class="multitable">
            <div class="table-responsive table-wrapper" id="scrollbar-inner">
                <table cellspacing="0" class="table-custom">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>Andrew Graham Electricals</td>
                            <td>Oslo, Norway</td>
                            <td class="quote-submitted">Submitted</td>
                            <td>$250</td>
                            <td>06:00 pm, Oct 31,2017</td>
                            <td>06:00 pm, Oct 31,2017</td>
                            <td class="op-semibold">
        ...
        <div id="approvedtab" class="multitable">
            <div class="table-responsive table-wrapper" id="scrollbar-inner">
                <table cellspacing="0" class="table-custom">
                    <thead>
                        <tr>
