    ...
    <div class="fm-table-section">
        ...
        <div class="fm-table-cell tbl-cell-2 skewpart">
            <div class="form-right-cell">
                ...
                <div class="form-logo"><img src="../images/logo.png" alt="logo"></div>
                <h2>Welcome</h2>
        ...
        <div class="fm-table-cell fm-cell tbl-cell-1">
            <div class="form-wrapper">
                ...
                <p class="succeed"><span><img src="public/images/checked.svg" alt="check"/></span>We have sent you reset password link successfully! Please check your Inbox</p>
                <p class="form-desciption">NOTE:-if you didn't find mail in your inbox then please check your spam folder as well for the reset password link.</p> 
