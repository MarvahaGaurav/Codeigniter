<div class="inner-container">
    <div class="container">
        ...
        <li><a href="<?php echo base_url('home/fast-calc/lux/applications/' . $applicationId . '/rooms/' . $roomId . '/products') ?>">Products</a></li>
        <li><a href="<?php echo base_url('home/fast-calc/lux/applications/' . $applicationId . '/rooms/' . $roomId . '/products/' . $productId) ?>">Details</a></li>
