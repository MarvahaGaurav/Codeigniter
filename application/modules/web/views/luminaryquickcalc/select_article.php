<div class="container">
    <ul class="breadcrumb"> 
        ...
        <li><a href="<?php echo base_url('home/fast-calc/luminary/applications/' . $application_id . '/rooms/' . $room_id . '/products') ?>">Products</a></li>
            ...
            <tbody>
                ...
                <tr class="">
                    ...
                    <td class="download text-right">
                        <div>
                            <div class="btn-group">
                                <button title="Select Product"  class="outline-btn" onclick="select_product( '<?php echo $specification['articlecode']; ?>', '<?php echo $specification['product_id']; ?>', <?php echo 1 ?>)">Select</button>
                                <button data-redirect-to="<?php echo "home/fast-calc/lux/applications/".$urlString.'/articles/'.$specification['articlecode']; ?>" title="Info"  class="outline-btn redirectable">View</button>
