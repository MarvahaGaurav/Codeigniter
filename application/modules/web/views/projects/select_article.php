            ...
            <tbody>
                ...
                <tr class="">
                    ...
                    <td class="download text-right">
                        <div>
                            <div class="btn-group">
                                <button title="Select Product"  class="outline-btn" onclick="select_product( '<?php echo $specification['articlecode']; ?>', '<?php echo $specification['product_id']; ?>', 1 )">Select</button>
