<div class="inner-container">
    <div class="container">
        ...
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo base_url("home/projects/{$projectId}/levels/{$level}") ?>">Levels</a></li>
            <li><a href="<?php echo base_url("home/projects/{$projectId}/levels/{$level}/rooms") ?>">Rooms</a></li>
            <li><a href="<?php echo base_url("home/projects/{$projectId}/levels/{$level}/rooms/{$projectRoomId}/edit") ?>">Edit Room Dimensions</a></li>
            <li><a href="<?php echo base_url("home/projects/{$projectId}/levels/{$level}/rooms/{$projectRoomId}/edit/products") ?>">Products</a></li>
            <li><a href="<?php echo base_url("home/projects/{$projectId}/levels/{$level}/rooms/{$projectRoomId}/edit/products/{$productId}/mounting/{$mounting}") ?>">Details</a></li>
                    ...
                    <div class="lighttypedetails">
                        ...
                        <div class="section-title clearfix">
                            <div class="button-wrapper">
                                ...
                                <button type="button" onclick="select_product( '<?php echo $articleData['articlecode']; ?>', '<?php echo $articleData['product_id']; ?>', <?php echo $mounting ?>)" class="custom-btn btn-width save">Select Product</button>
                            </div>
                        </div>
                        <!-- button wrapper section -->
                    </div>
        ...
        <div class="thumb-view-footer">
            ...
            <div class="row thumb-footer-detail">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <input type="hidden" name="project_room_id" id="project_room_id" value="<?php echo isset($projectRoomId)?$projectRoomId:''; ?>">
                    <input type="hidden" name="projectRoomId" id="projectRoomId" value="<?php echo isset($projectRoomId)?encryptDecrypt($projectRoomId, 'decrypt'):''; ?>">
