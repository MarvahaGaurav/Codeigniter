...
<!--                            <td class="text-center">v1.1</td>
                            ...
                            <td class="op-semibold">
                                ...
                                <a href="javascript:void(0)" class="confirmation-action-xhttp project-action"  title="<?php echo $this->lang->line('delete_text') ?>"  data-redirect="<?php echo base_url(uri_string()) ?>" data-target="#project-<?php echo $key ?>" data-json='<?php echo $project['clone_data'] ?>' data-url="<?php echo base_url('xhttp/project/remove') ?>" data-title="<?php echo $this->lang->line('delete_project') ?>" data-message="<?php echo $this->lang->line('delete_project_confirmation') ?>">
