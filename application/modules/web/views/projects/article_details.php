<div class="inner-container">
    <div class="container">
        ...
        <li><a href="<?php echo base_url('home/projects') ?>">Projects</a></li>
            ...
            <li><a href="<?php echo base_url('home/projects/' . $projectId . '/levels/' . $level . '/rooms/applications/' . $applicationId . '/rooms') ?>">Room Type</a></li>
            <li><a href="<?php echo base_url('home/projects/' . $projectId . '/levels/' . $level . '/rooms/applications/' . $applicationId . '/rooms/' . $roomId . '/dimensions') ?>">Add Room</a></li>
            <li><a href="<?php echo base_url('home/projects/' . $projectId . '/levels/' . $level . '/rooms/applications/' . $applicationId . '/rooms/' . $roomId . '/dimensions/products') ?>">Products</a></li>
            <li><a href="<?php echo base_url('home/projects/' . $projectId . '/levels/' . $level . '/rooms/applications/' . $applicationId . '/rooms/' . $roomId . '/dimensions/products/' . $productId . '/mounting/' . $mounting) ?>">Details</a></li>
                    ...
                    <div class="lighttypedetails">
                        ...
                        <div class="section-title clearfix">
                            <div class="button-wrapper">
                                ...
                                <button type="button" class="custom-btn btn-width save" onclick="select_product( '<?php echo $articleData['articlecode']; ?>', '<?php echo $articleData['product_id']; ?>', <?php echo $mounting ?>)">Select Product</button>
                            </div>
                        </div>
                        <!-- button wrapper section -->
                    </div>
        ...
        <div class="thumb-view-footer">
            ...
            <div class="row thumb-footer-detail">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <input type="hidden" name="product_name" id="product_name" value="<?php echo $productData['title'] ?>">
                    <input type="hidden" name="application_id" id="application_id" value="<?php echo isset($applicationId)?$applicationId:''; ?>">
                    <input type="hidden" name="room_id" id="room_id" value="<?php echo isset($roomId)?$roomId:''; ?>">
                </div>
