                        ...
                        <div class="form-group">
                            ...
                            <div class="commn-select-wrap">
                                ...
                                <select class="selectpicker" name="status">
                                      ...
                                      <option <?php if(isset($pages['status']) && $pages['status']==ACTIVE || set_value('status')==ACTIVE) { echo "selected='selected'";
                                     }?> value="<?php echo ACTIVE;?>">Active</option>
                                      <option <?php if(isset($pages['status']) && $pages['status']==INACTIVE || set_value('status')==INACTIVE) { echo "selected='selected'";
