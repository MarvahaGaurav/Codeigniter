            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-4">
                    <div class="srch-wrap">
                        ...
                        <input type="text" class="search-box searchlike" value="<?php echo $searchlike ?>" placeholder="Search" id="searchlike" name="searchlike">
                    </div>
                </div>
                ...
                <?php if (!empty($notiList)) { ?>
                    <?php foreach ($notiList as $list) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0);" aria-hidden="true" data-toggle="modal" data-target="#editModal" onclick="$('#notiToken').val('<?php echo $list['id'] ?>')" class="send-btn">Resend</a>
