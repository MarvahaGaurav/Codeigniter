        ...
        <div class="white-wrapper p-a-sm clearfix">
                   ...
                   <div class="clear"></div>
                    ...
                    <div class="col-xs-7 col-sm-7 col-lg-7">
                        <ul class="session-tabs clearfix">
                            <li><label>Active</label> <input type="radio"  value="1" <?php if(!empty($admindetail['status']==1)) {echo "checked";
                           } ?> name="status" class="status" ></li>
                            <li><label>Deactive</label> <input type="radio" value="0" <?php  if(!empty($admindetail['status'] == 0)) { echo "checked";
                           }  ?> name="status"  class="status" ></li>
          ...
          <div class="row">
                    ...
                    <div class="col-lg-12">
                            ...
                            <ul class="check-column">
                                <li>
                                    <div class="custom-check">
                                       ...
                                       }?>  <?php echo (count($userpermission) == 0)?"disabled":"" ?> class="user" type="checkbox">
                            ...
                            <ul class="check-column">
                                <li>
                                    <div class="custom-check">
                                       ...
                                       }?><?php echo (count($optionpermission) == 0)?"disabled":""?>  class="Option" type="checkbox">
                            ...
                            <ul class="check-column">
                                <li>
                                    <div class="custom-check">
                                       ...
                                       } ?> <?php echo (count($portfoliopermission) == 0)?"disabled":""?>class="Portfolio"  type="checkbox">
                            ...
                            <ul class="check-column">
                                <li>
                                    <div class="custom-check">
                                       ...
                                       }?><?php echo (count($videopermission) == 0)?"disabled":""?> class="Video" type="checkbox">
                            ...
                            <ul class="check-column">
                                <li>
                                    <div class="custom-check">
                                       ...
                                       } ?><?php echo (count($notificationpermission) == 0)?"disabled":""?>  type="checkbox">
                            ...
                            <ul class="check-column">
                                <li>
                                    <div class="custom-check">
                                       ...
                                       }?> <?php echo (count($feedbackpermission) == 0)?"disabled":""?> type="checkbox">
                            ...
                            <ul class="check-column">
                                <li>
                                    <div class="custom-check">
                                       ...
                                       }  ?><?php echo (count($apppermission) == 0)?"disabled":""?>  type="checkbox">
                        ...
                        <div class="clear"></div>
                        <div class="custom-check main-check">
                            <input id="main-check8" name="broker" onchange="permission('Broker')" value="8"<?php if(count($brokerpermission)) { echo "checked";
                           }  ?> type="checkbox">
                            ...
                            <ul class="check-column">
                                <li>
                                    <div class="custom-check">
                                       ...
                                       }?><?php echo (count($brokerpermission) == 0)?"disabled":"" ?>  type="checkbox">
