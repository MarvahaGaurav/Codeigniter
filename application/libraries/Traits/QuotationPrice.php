 ...
 */
trait QuotationPrice
{
    private $priceData;

    private $productCharges;

    private function originalQuotationPrice($companyId, $projectId, $level = 0)
    {
        ...
        return $this->originalTotalPriceCalculation();
    }

    private function originalTotalPriceCalculation()
    {
