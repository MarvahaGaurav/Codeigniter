...
$route['home/quotes/projects/(:any)'] = 'web/QuotesController/project_details/$1'; 
$route['home/quotes/projects/(:any)/edit']='web/QuotesController/editProject/$1';
$route['home/quotes/projects/(:any)/levels/(:num)/rooms'] ='web/QuotesController/projectResultRoomListing/$1/$2';
$route['home/quotes/projects/(:any)/levels/(:num)/rooms/(:any)/project-rooms/(:any)/selected-products'] = 'web/QuotesController/selectedProjectProducts/$1/$2/$3/$4';
$route['home/quotes/projects/view-result/(:any)'] = 'web/QuotesController/view_result/$1';
