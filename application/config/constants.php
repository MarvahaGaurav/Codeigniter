...
defined("AWAITING_REQUEST_CUSTOMER") or define("AWAITING_REQUEST_CUSTOMER", 1);
defined("AWAITING_REQUEST_TECHNICIAN") or define("AWAITING_REQUEST_TECHNICIAN", 2);
defined("QUOTED_REQUEST_CUSTOMER") or define("QUOTED_REQUEST_CUSTOMER", 1);
defined("QUOTED_REQUEST_TECHNICIAN") or define("QUOTED_REQUEST_TECHNICIAN", 2);
