...
defined("MAXIMUM_REQUEST_COUNTS_PER_PROJECT") or define('MAXIMUM_REQUEST_COUNTS_PER_PROJECT', 3);

defined('PROJECT_ROOM_MAIN_PRODUCT') or define('PROJECT_ROOM_MAIN_PRODUCT', 1);
defined('PROJECT_ROOM_ACCESSORY_PRODUCT') or define('PROJECT_ROOM_ACCESSORY_PRODUCT', 2);
defined('BLOCKED_USER_CODE') or define('BLOCKED_USER_CODE', 600);
defined('WEB_PAGE_LIMIT') or define('WEB_PAGE_LIMIT', 5);
defined('DIALUX_AUTH_TOKEN') or define('DIALUX_AUTH_TOKEN', '28c129e0aca88efb6f29d926ac4bab4d');

defined('PGINATION_LIMIT') or define('PGINATION_LIMIT', 10);

defined('BLOCKED_BY_SUPER_ADMIN') or define('BLOCKED_BY_SUPER_ADMIN',2);

defined('USER_PERMISSION') or define('USER_PERMISSION',1);
defined('MERCHANT_PERMISSION') or define('MERCHANT_PERMISSION',2);
defined('PRODUCT_PERMISSION') or define('PRODUCT_PERMISSION',3);
defined('TEMPLATE_PERMISSION') or define('TEMPLATE_PERMISSION',4);
defined('CONTENT_PERMISSION') or define('CONTENT_PERMISSION',5);
defined('VERSION_PERMISSION') or define('VERSION_PERMISSION',6);
defined('NOTIFICATION_PERMISSION') or define('NOTIFICATION_PERMISSION',7);
defined('MESSAGE_PERMISSION') or define('MESSAGE_PERMISSION',8);

defined("NOTIFICATION_EMPLOYEE_REQUEST_RECEIVED") or define("NOTIFICATION_EMPLOYEE_REQUEST_RECEIVED", 1);
defined("NOTIFICATION_RECEIVED_QUOTES") or define("NOTIFICATION_RECEIVED_QUOTES", 2);
defined("NOTIFICATION_PERMISSION_GRANTED") or define("NOTIFICATION_PERMISSION_GRANTED", 3);
...
defined("NOTIFICATION_EMPLOYEE_REJECTED") or define("NOTIFICATION_EMPLOYEE_REJECTED", 8);
defined("NOTIFICATION_ADMIN_NOTIFICATION") or define("NOTIFICATION_ADMIN_NOTIFICATION", 20);

defined("SILENT_NOTIFICATION_PERMISSION_GRANTED") or define("SILENT_NOTIFICATION_PERMISSION_GRANTED", 1);
defined("QUOTATION_EXPIRY_MONTH") or define("QUOTATION_EXPIRY_MONTH", 3);
