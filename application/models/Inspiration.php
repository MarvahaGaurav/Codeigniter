...
class Inspiration extends BaseModel {
    ...
    public function get($options) 
    {
        ...
        if ( isset($options['inspiration_id']) && !empty($options['inspiration_id']) ) {
            ...
            $this->db->select("SQL_CALC_FOUND_ROWS i.id as inspiration_id, company.company_name, company.company_address, i.company_id, title, description, i.status" . $media , FALSE);
        }
